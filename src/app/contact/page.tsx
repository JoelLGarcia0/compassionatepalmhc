            ...
            <div className="lg:col-span-2">
              <div className="space-y-8">
                ...
                <div className="rounded-xl border border-sand bg-cream/40 p-8 testimonial-bar">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-black tracking-wide">Fax</p>
                        <p className="text-sm text-charcoal mt-0.5">(305) 952-4188</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <svg className="h-5 w-5 text-accent mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <div className="overflow-hidden rounded-xl border border-sand">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3589.8!2d-80.1868!3d25.9421!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88d9ad1c1e26bfb7%3A0x0!2s1380+NE+Miami+Gardens+Dr+Suite+275%2C+Miami%2C+FL+33179!5e0!3m2!1sen!2sus!4v1700000000000"
                    width="100%"
                    height="256"
                    style={{ border: 0 }}
                    allowFullScreen
                    ...
                    title="Compassionate Palm Health Care location"
                  />
                </div>
